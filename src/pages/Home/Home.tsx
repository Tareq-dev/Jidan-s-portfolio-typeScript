...
const Home = () => {
     return (
          ...
          <p className='text-white text-xl md:text-3xl font-mono font-bold mt-3'>Cancer Reasearcher at</p>
          <p className='text-white text-xl md:text-3xl font-mono font-bold'>University of Chittagong</p>
          </div>
          </div>
